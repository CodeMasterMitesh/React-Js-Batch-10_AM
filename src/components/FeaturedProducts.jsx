...
const FeaturedProducts = () => {
    const featuredProducts = [
        ...
        },
        {
            ...
            image: "https://images.unsplash.com/photo-1606510907446-c86d4f4ec0a8?w=400&h=400&fit=crop",
            rating: 4.7,
            reviews: 987,
            badge: "Best Value",
        ...
        <section className={styles.featuredSection}>
            <div className={styles.container}>
                <div className={styles.sectionHeader}>
                    ...
                    <p>Handpicked excellence - Our curated selection of premium products</p>
                </div>
