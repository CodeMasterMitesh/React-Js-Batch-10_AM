      ...
      <div className={styles.container}>
        ...
        <div className={styles.voucherGrid}>
          {vouchers.map((voucher) => (
            <div key={voucher.id} className={styles.voucherCard}>
              ...
              >
                <div className={styles.voucherIcon}>{voucher.icon}</div>
                <div className={styles.discountBadge}>{voucher.discount}</div>
              </div>
        ...
        <div className={styles.ctaBanner}>
          <div className={styles.ctaContent}>
            ...
            <p>
              Subscribe to our newsletter and get special vouchers delivered to
              your inbox
            </p>
