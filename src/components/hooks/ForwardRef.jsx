    ...
    return (
        ...
        <>
            <form onSubmit={handleSubmit}>
                ...
                <button type="submit" style={{ padding: '8px 16px', borderRadius: '4px', border: 'none', backgroundColor: '#4CAF50', color: 'white', cursor: 'pointer' }}>Submit</button>
            </form>
        </>
    )
...
const Input = ({type, label,ref}) => {
    ...
    return (
        <div>
            ...
            <input id={id} type={type} ref={ref} style={{ padding: '8px', margin: '8px 0', borderRadius: '4px', border: '1px solid #ccc' }} />
        </div>
    )
};